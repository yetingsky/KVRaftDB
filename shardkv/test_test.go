...
//
func TestHahaStaticShards(t *testing.T) {
...
func TestHahaJoinLeave(t *testing.T) {
...
func TestHahaSnapshot(t *testing.T) {
...
//
func TestHahaChallenge2Unaffected(t *testing.T) {
...
//
func TestHahaChallenge2Partial(t *testing.T) {
